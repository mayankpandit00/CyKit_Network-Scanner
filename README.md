# CyKit Series  
## 2) Network Scanner
A pthon program in cybersecurity kit series that scans all the available devices on the network.
...
5. Usage : 
   1. sudo python network_scanner.py -t [Target IP/Target IP Range] 
